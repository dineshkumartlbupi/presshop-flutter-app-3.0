...
// Reusable widget for Price Image and Button
  static Widget priceImageWithButton(Size size, String amount, String hour,
  ...
  // static Widget errorMessageWidget(String message) {
  //   return Center(
  //     child: Container(
  ...
  static Widget commonRefresherFooter(BuildContext context, LoadStatus? mode) {
    Widget body;
  ...
  static Widget showLoader({bool isForLocation = false}) {
  ...
  /// Calender
  static Future<String?> commonDatePicker({String? date}) async {
  ...
  /// FilterIcon
  static Container commonFilterIcon(Size size) {
    return Container(
  ...
  static Widget getMediaCountCard(String mediaType, int count, Size size) {
    return Container(
      width: size.width * AppDimensions.numD11,
      padding:
          EdgeInsets.symmetric(vertical: size.width * AppDimensions.numD01),
  ...
  static List<Widget> getMediaCount(
      List<ContentMediaData> contentMediaList, Size size) {
    final imageCount =
  ...
  static List<Widget> getMediaCount2(
