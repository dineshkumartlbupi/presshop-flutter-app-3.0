...
class MyProfileData {
  MyProfileData.fromJson(json) {
    ...
    joinedDate = json["createdAt"] != null
        ...
        : "";
    var doc = (json["doc_to_become_pro"] is Map) ? json["doc_to_become_pro"] : null;
    validDegree = doc != null
        ? doc["govt_id_mediatype"].toString()
        : "";
    validMemberShip = doc != null
        ? doc["photography_mediatype"].toString()
        : "";
    validBritishPassport = doc != null
        ? doc["comp_incorporation_cert_mediatype"].toString()
        : "";
  }
  MyProfileData();
  String firstName = "";
