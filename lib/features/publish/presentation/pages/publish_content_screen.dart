                    ...
                    children: [
                      ...
                      widget.publishData != null ||
                          ...
                          ? Padding(
                              ...
                              child: SizedBox(
                                  height: size.width * AppDimensions.numD37,
                                  child: Row(
                                    children: [
                                      InkWell(
                                        onTap: () {
  ...
  Future<void> _fetchCurrentLocation() async {
    ...
    try {
      ...
      if (locationData != null) {
        ...
        // Handle permission denial or disabled GPS
          ...
          if (mounted) {
            showDialog(
              ...
              builder: (context) => AlertDialog(
                ...
                content: const Text(
                    "Location access is disabled. Please enable it in app settings to provide accurate content metadata."),
                actions: [
                  TextButton(
