...
//                             size,
//                             widget.taskDetail!.task.hopperTaskAmount,
//                             widget.taskDetail!.task.hopperInfo.isNotEmpty
//                                 ? widget.taskDetail!.task.hopperInfo.first.hours
//                                 : "0",
//                           ),
//                           SizedBox(height: size.width * AppDimensions.numD03),
//                         ],
...
//                             Visibility(
//                               visible: item.messageType == "initialoffer" ||
//                                   item.messageType == "updateOffer" ||
//                                   item.messageType ==
//                                       "Mediahouse_initial_offer",
//                               child: mediaHouseOfferWidget(
//                                 item,
//                                 item.messageType == "Mediahouse_initial_offer",
//                                 size,
//                               ),
//                             ),
...
//                             ),
//                             Visibility(
//                               visible: item.messageType == "action_required",
//                               child: leftActionChatWidget(item, size),
//                             ),
//                             Visibility(
//                               visible: item.messageType == "text" &&
//                                   item.senderType == "MediaHouse",
//                               child: leftTextChatWidget(item, size),
//                             ),
//                             Visibility(
//                               visible: item.messageType == "action_response",
//                               child: rightActionResponseWidget(item, size),
//                             ),
//                             Visibility(
//                               visible:
...
//               color: Colors.black,
//             ),
//             SizedBox(width: size.width * AppDimensions.numD012),
//             Text(
...
//               child: Padding(
//                 padding: EdgeInsets.only(
//                   right: size.width * AppDimensions.numD13,
//                 ),
//                 child: Text(
...
//         context.pushNamed(
//           AppRoutes.fullVideoViewName,
//           extra: {'mediaFile': audioUrl, 'type': MediaTypeEnum.audio},
//         );
//       },
//       child: Column(
//         crossAxisAlignment: CrossAxisAlignment.start,
...
//         context.pushNamed(
//           AppRoutes.fullVideoViewName,
//           extra: {'mediaFile': imageUrl, 'type': MediaTypeEnum.image},
//         );
//       },
//       child: Column(
//         crossAxisAlignment: CrossAxisAlignment.start,
...
//                         clipBehavior: Clip.antiAlias,
//                         child: Image.network(
//                           sharedPreferences!.getString(avatarKey).toString(),
//                           height: size.width * AppDimensions.numD09,
//                           width: size.width * AppDimensions.numD09,
//                           fit: BoxFit.cover,
//                           errorBuilder: (context, exception, stackTrace) {
...
//   Widget thanksToUploadMediaWidget(
//     String type,
//     var size,
//     String imgCount,
//     String vidCount,
...
//               crossAxisAlignment: CrossAxisAlignment.start,
//               children: [
//                 SizedBox(height: size.width * AppDimensions.numD008),
//                 RichText(
//                   text: TextSpan(
//                     style: TextStyle(
//                       color: Colors.white,
...
//                               var map1 = {"chat_id": item.id, "status": true};
//                               socketEmitFunc(
...
//                           onPressed: () {
//                             if (item.requestStatus.isEmpty) {
//                               var map1 = {"chat_id": item.id, "status": false};
...
//                     crossAxisAlignment: CrossAxisAlignment.start,
//                     children: [
//                       SizedBox(height: size.width * AppDimensions.numD009),
//                       Row(
//                         mainAxisAlignment: MainAxisAlignment.start,
//                         crossAxisAlignment: CrossAxisAlignment.start,
//                         children: [
...
//                         alignment: Alignment.center,
//                         padding: EdgeInsets.all(
//                           size.width * AppDimensions.numD012,
//                         ),
//                         decoration: BoxDecoration(
//                           color: AppColorTheme.colorLightGrey,
//                           borderRadius: BorderRadius.circular(
...
//               child: Container(
//                 margin: EdgeInsets.only(
//                   bottom: size.width * AppDimensions.numD06,
//                 ),
//                 padding: EdgeInsets.symmetric(
//                   horizontal: size.width * AppDimensions.numD05,
//                   vertical: size.width * AppDimensions.numD02,
...
//         ),
//         showCelebration
//             ? Lottie.asset("assets/lottieFiles/celebrate.json")
//             : Container(),
//       ],
//     );
//   }
...
//   Widget leftActionChatWidget(ManageTaskChatModel item, var size) {
//     debugPrint("🔵 leftActionChatWidget called");
//     debugPrint("🔵 Message: ${item.message}");
//     debugPrint("🔵 Message Type: ${item.messageType}");
//     debugPrint("🔵 Options: ${item.options}");
//     debugPrint("🔵 Options length: ${item.options.length}");

//     return Row(
//       crossAxisAlignment: CrossAxisAlignment.start,
//       children: [
//         mediaHouseAvatar(size),
//         SizedBox(width: size.width * AppDimensions.numD04),
//         Expanded(
//           child: Container(
//             padding: EdgeInsets.all(size.width * AppDimensions.numD04),
...
//                             ),
//                             () {
//                               debugPrint("🟢 Button clicked: $option");
//                               socketEmitFunc(
//                                 socketEvent: "chat message",
...
//   Widget leftTextChatWidget(ManageTaskChatModel item, var size) {
//     return Row(
//       crossAxisAlignment: CrossAxisAlignment.start,
//       children: [
//         mediaHouseAvatar(size),
...
//   Widget mediaHouseAvatar(var size) {
//     return Container(
//       decoration: BoxDecoration(
//         color: Colors.white,
//         shape: BoxShape.circle,
...
//   Widget rightActionResponseWidget(ManageTaskChatModel item, var size) {
//     String avatar = sharedPreferences!.getString(avatarKey) ?? "";
//     bool isYes = item.message.toLowerCase() == "yes";
