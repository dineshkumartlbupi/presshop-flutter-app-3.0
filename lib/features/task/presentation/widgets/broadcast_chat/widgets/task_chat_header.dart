...
class TaskChatHeader extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Stack(
      children: [
            ...
            children: [
              ...
              Row(
                children: [
                  ...
                  const Spacer(),
                  _buildMediaHouseProfile(context, size),
                ],
              ),
              ...
              priceImageWithButton(
                ...
                taskDetail.task.hopperInfo.isNotEmpty
                    ...
                    : "0",
                localCurrencySymbol: taskDetail.task.currencySymbol.isNotEmpty
        ...
        _buildCheckIcon(context, size),
      ],
    );
  }

  Widget _buildMediaHouseProfile(BuildContext context, Size size) {
    return Container(
      decoration: BoxDecoration(
        color: Theme.of(context).brightness == Brightness.dark
            ? AppColorTheme.colorDarkThemeCard
  ...
  Widget _buildCheckIcon(BuildContext context, Size size) {
    return Align(
