...
// class OptimisedMapPage extends StatefulWidget {
//   const OptimisedMapPage(
...
//   @override
//   State<OptimisedMapPage> createState() => _OptimisedMapPageState();
// }

// class _OptimisedMapPageState extends State<OptimisedMapPage> {
...
//     // Added stability guard to prevent freeze during fast transitions
...
//         if (!_isStable || !_isVisible) return;
...
//                   circles: {
//                     ...state.circles
//                         .where((c) => c.circleId.value != 'my_location_pulse'),
