...
//           if (state.status == AlertStatus.success ||
...
//                                 state.status == AlertStatus.success
...
//                                             margin: EdgeInsets.all(size.width *
//                                                 AppDimensions.numD03),
//                                             decoration: BoxDecoration(
//                                               color:
...
//   Future<void> openUrl(
//       List<double>? coordinates, LatLng? currentLocation) async {
//     if (coordinates == null || coordinates.isEmpty || currentLocation == null) {
//       if (currentLocation == null) {
//         showSnackBar(
//             "Location Error",
//             "Current location not found. Please enable location permissions.",
//             Colors.red);
//       }
//       return;
//     }
